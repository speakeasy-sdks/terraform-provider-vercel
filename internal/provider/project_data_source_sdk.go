...
func (r *ProjectDataSourceModel) RefreshFromOperationsGetProjectResponseBody(resp *operations.GetProjectResponseBody) {
	if resp != nil {
		...
		if resp.PasswordProtection == nil {
			...
			r.PasswordProtection = &tfTypes.GetProjectLastRollbackTarget{}
		}
		...
		if resp.SsoProtection == nil {
			...
			r.SsoProtection = &tfTypes.GetProjectSsoProtection{}
