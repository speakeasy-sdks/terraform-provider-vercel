...
type GetProjectLatestDeployments struct {
	...
	AliasAssigned          *GetProjectAliasAssigned             `tfsdk:"alias_assigned"`
	AliasError             *GetProjectAliasError                `tfsdk:"alias_error"`
	...
	Builds                 []GetProjectBuilds                   `tfsdk:"builds"`
	...
	Creator                *GetProjectCreator                   `tfsdk:"creator"`
	...
	OidcTokenClaims        map[string]GetProjectOidcTokenClaims `tfsdk:"oidc_token_claims"`
