...
func (s *LogDrains) Create(ctx context.Context, request operations.CreateLogDrainRequest) (*operations.CreateLogDrainResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *LogDrains) Delete(ctx context.Context, request operations.DeleteIntegrationLogDrainRequest) (*operations.DeleteIntegrationLogDrainResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *LogDrains) Get(ctx context.Context, request operations.GetConfigurableLogDrainRequest) (*operations.GetConfigurableLogDrainResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// List - Retrieves a list of all the Log Drains
// Retrieves a list of all the Log Drains owned by the account. This endpoint must be called with an account AccessToken (integration OAuth2 clients are not allowed). Only log drains owned by the authenticated account can be accessed.
func (s *LogDrains) List(ctx context.Context, request operations.GetAllLogDrainsRequest) (*operations.GetAllLogDrainsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	res := &operations.GetAllLogDrainsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out []operations.GetAllLogDrainsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *LogDrains) CreateConfigurable(ctx context.Context, request operations.CreateConfigurableLogDrainRequest) (*operations.CreateConfigurableLogDrainResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
